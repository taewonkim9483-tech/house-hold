...
export function GoogleLoginButton({ locale, next, label }: GoogleLoginButtonProps) {
  ...
  return (
    <button
      onClick={handleLogin}
      disabled={loading}
      className="w-full flex items-center justify-center gap-3 py-[14px] px-4 rounded-[13px] font-semibold text-[15px] transition-all duration-200 cursor-pointer disabled:opacity-60 disabled:cursor-not-allowed"
      style={{
        background: 'linear-gradient(135deg, rgba(139,92,246,0.85) 0%, rgba(99,102,241,0.85) 100%)',
        border: '1px solid rgba(255,255,255,0.4)',
        borderTop: '1px solid rgba(255,255,255,0.55)',
        color: '#fff',
        boxShadow: '0 6px 24px rgba(139,92,246,0.35), inset 0 1px 0 rgba(255,255,255,0.25)',
